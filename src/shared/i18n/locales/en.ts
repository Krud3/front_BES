const en = {
  ...
  spike: {
    header: {
      title: "Cosmograph Spike — Phase 3",
      backToBoard: "Back to board",
    ...
    controls: {
      ...
      agents50k: "50 k",
      agents100k: "100 k",
      edgeDensityLabel: "Edges per agent",
      edges0: "0 (no edges)",
      edges5: "5",
      edges10: "10",
      tickRateLabel: "Tick rate",
      tick30: "30 Hz",
      tick60: "60 Hz",
      strategyLabel: "Hot-path strategy",
      strategyRutaA: "Ruta A (rebuild table)",
      strategyRutaC: "Ruta C (mutate arrays)",
      strategyRutaD: "Ruta D (mutate GPU buffers)",
      start: "Start",
      stop: "Stop",
      reset: "Reset",
      initializing: "Warming up layout…",
      statusIdle: "Idle",
    ...
    hud: {
      ariaLabel: "FPS performance counter",
      title: "FPS",
      current: "Current",
      avg1s: "Avg 1 s",
      avg5s: "Avg 5 s",
      ...
      dropped: "Dropped",
      elapsed: "Elapsed",
      tickErrors: "Tick errors",
    },
    log: {
      title: "Event log",
      empty: "No events yet.",
      starting: "Starting — {{agents}} agents, {{edges}} edges/agent, {{rate}} Hz, {{strat}}",
      topologyBuilt: "Topology built: {{agents}} agents, {{links}} links",
      warmupStarted: "Warm-up layout started (5 s)…",
      warmupDone: "Warm-up complete — freezing layout",
      warmupTimeout: "Warm-up timed out — freezing layout anyway",
      layoutFrozen: "Layout frozen",
      mountComplete: "Cosmograph mounted",
      tickLoopStarted: "Tick loop started",
      firstTick: "First tick received",
      firstManualTick: "First manual Arrow tick OK ({{ms}} ms)",
      tickMilestone: "Tick #{{round}} reached",
      tickError: "Per-tick setConfig error: {{message}}",
      stopped: "Stream stopped by user",
      errorNoRef: "Cosmograph ref not available — cannot start tick loop",
      preparingData: "Preparing data…",
      dataPrepared: "Data prepared ({{ms}} ms) — mounting Cosmograph",
      preparedSchema:
        "Prepared schema: [{{columns}}] — pointIdBy={{idBy}}, pointIndexBy={{indexBy}}",
      tooManyTickErrors: "Too many tick errors ({{count}}) — stopping tick loop",
      rutaDBuffersOk: "Ruta D — GPU buffers acquired (colors len={{cLen}}, sizes len={{sLen}})",
      rutaDBuffersUnavailable:
        "Ruta D — getPointColors()/getPointSizes() returned undefined; cannot mutate",
      rutaDFirstMutation: "Ruta D — first GPU buffer mutation OK ({{ms}} ms)",
    },
    canvas: {
      warmingUp: "Warming up force layout…",
      warmupHint: "Running simulation for {{seconds}} s then freezing",
      preparingData: "Preparing data…",
      idleHint: "Configure and press Start",
      stoppedHint: "Stream stopped",
      idleSubhint: "Select agent count, strategy, and tick rate in the left panel",
    },
  },
} as const;
