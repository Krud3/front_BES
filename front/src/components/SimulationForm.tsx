...
export function SimulationForm() {
  ...
  const onFormSubmit = async (data: FormValues) => {
    console.log("onFormSubmit triggered. Form data:", data);
    if (!isFormValid) {
      // This alert should fire if the button was somehow enabled while the form was invalid
    ...
    try {
      ...
      console.log("Buffer created. Sending request to the server...");
      ...
      if (!response.ok) {
        // Provide feedback on failed HTTP requests
